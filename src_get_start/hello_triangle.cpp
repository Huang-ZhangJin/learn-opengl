...
int main()
{
    ...
    // a fragment shader is allowed to write to multiple framebuffers, you need to explicitly specify which output is written to which framebuffer. 
    ...
    {   
        ...
        // float randnum = (sin(time * 10000.0f) + 1.0f) / 2.0f;
        // std::cout << randnum << std::endl;
        // glUniform3f(uniColor, randnum, 0.0f, 0.0f);
